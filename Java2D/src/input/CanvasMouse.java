...
public class CanvasMouse implements MouseListener, MouseMotionListener {
	...
	private static CanvasMouse instance = null;
	...
	public static CanvasMouse getInstance(Component component) {
		if (instance == null)
			instance = new CanvasMouse(component);
		return instance;
	}

	private CanvasMouse(Component component) {
	...
	public void setMousePosition() {
		if (robot != null && component.isShowing()) {
			Point copy = new Point(myX, myY);
			SwingUtilities.convertPointToScreen(copy, component);
			robot.mouseMove(copy.x, copy.y);
		}
	}

	public void setXMousePosition(int x) {
		myX = x;
	}

	public void setYMousePosition(int y) {
		myY = y;
	}
